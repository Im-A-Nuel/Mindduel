// AUTO-MIRRORED from backend/src/data/questions.ts (single source of truth for
// the trivia bank). vs-AI / free-play runs fully client-side, so it needs a
// local copy of the bank; PvP fetches from the backend API instead. Keep this
// in sync when editing the backend bank.
...
export const TRIVIA_BANK: TriviaBankQuestion[] = [
